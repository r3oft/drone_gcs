    ...
    try:
        ...
        try:
            ...
            with open(log_file, 'w') as f:
                # 写入文件头
                f.write("时间(s)\t高度(m)\tServo1\tServo2\tServo3\tServo4\n")
                f.write("="*60 + "\n")
                ...
                while True:
                    try:
                        ...
                        # 写入文件
                        f.write(f"{elapsed}\t{latest_servo_raw['servo1']}\t{latest_servo_raw['servo2']}\t{latest_servo_raw['servo3']}\t{latest_servo_raw['servo4']}\n")
                        f.flush()  # 实时保存
                    except:
                        pass
                    time.sleep(0.1)
